...
class GeneratorUNet(nn.Module):
	def __init__(self, in_channels=1, out_channels=6):
		...
		self.down8 = UNetDown(512, 512, normalize=False, dropout=0.5)  # 不用BN

		self.up1 = UNetUp(512, 512, dropout=0.5)
		self.up2 = UNetUp(1024, 512, dropout=0.5)  # 有跳跃传递的512
		self.up3 = UNetUp(1024, 512, dropout=0.5)
		self.up4 = UNetUp(1024, 512, dropout=0.5)
		self.up5 = UNetUp(1024, 256)               # 有跳跃传递的256
		self.up6 = UNetUp(512, 128)                # 跳跃输入128
		self.up7 = UNetUp(256, 64)                 # 跳跃输入64
	...
	def forward(self, x):
		...
		print(d8.data.shape, d7.data.shape)
		u1 = self.up1(d8, d7)  # 512u + 512d
		u2 = self.up2(u1, d6)  # 512u + 512d
		u3 = self.up3(u2, d5)  # 512u + 512d
		u4 = self.up4(u3, d4)  # 512u + 512d
		u5 = self.up5(u4, d3)  # 256u + 256d
		u6 = self.up6(u5, d2)  # 128u + 128d
		u7 = self.up7(u6, d1)  # 64u + 64d
		# u7的输出channels=128
